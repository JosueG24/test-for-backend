...
export default function ModeCookies({url}) {
    ...
    async function handleSubmit(e){
        e.preventDefault()
        console.log({url:e.target.urlInp.value , domain:e.target.domainInp.value})
        const response = await axios.post(url+e.target.urlInp.value,{domain:e.target.domainInp.value} ,{withCredentials:true})
